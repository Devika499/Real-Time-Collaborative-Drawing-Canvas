...
function setupToolControls(canvasManager) {
...
function setupColorControls(canvasManager) {
...
function setupStrokeWidthControl(canvasManager) {
...
function setupActionButtons(wsManager) {
...
function setupUserInterface(wsManager) {
